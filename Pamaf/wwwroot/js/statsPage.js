window.onload = function() {
	...
	request.onload = function(e) {
		...
		let averageScore = userSessions.reduce(function(a, b) {
			return a + b.score;
        ...
        let startedPlaying = new Date(userSessions.reduce((r1, r2) => (r1.date < r2.date ? r1 : r2)).date);
        ...
        document.getElementById("startedPlaying").innerText = startedPlaying.getDate() + "-" + (startedPlaying.getMonth() + 1) + "-" + startedPlaying.getFullYear();
	};
